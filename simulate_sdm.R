...
pp<-rLGCP("matern",mu=function(x,y){params$b0[k]+params$b1[k]*x+params$b2[k]*y},var=params$sigma[k]^2,scale=1/params$kappa[k],nu=params$nu[k],win=o,dimyx=c(300,300))
cutoff<-300000
if(pp$n>cutoff){
  pn<-pp$n
  rm(pp)
